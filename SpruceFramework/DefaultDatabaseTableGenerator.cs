...
namespace SpruceFramework
{
    public class DefaultDatabaseTableGenerator : IDatabaseTableGenerator
    {
        ...
        {
            var tableName = Spruce.GetTableNameForType(type);
        ...
        {
            var fromTable = Spruce.GetTableNameForType(relation.SourceType);
            var toTable = Spruce.GetTableNameForType(relation.DestinationType);
