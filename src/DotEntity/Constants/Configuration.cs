 ...
 * 
 * This file (Configuration.cs) is part of dotEntity(https://github.com/RoastedBytes/dotentity).
 * 
 ...
 */
namespace DotEntity.Constants
{
    public static class Configuration
    {
        public static string VersionTableName = "__DotEntityVersions";
    }
}