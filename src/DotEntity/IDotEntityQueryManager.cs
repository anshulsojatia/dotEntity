 ...
 * 
 * This file (IDotEntityQueryManager.cs) is part of dotEntity(https://github.com/RoastedBytes/dotentity).
 * 
...
namespace DotEntity
{
    public interface IDotEntityQueryManager : IWrappedDisposable
    {
