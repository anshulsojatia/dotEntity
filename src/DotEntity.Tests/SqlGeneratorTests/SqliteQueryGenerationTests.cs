...
namespace DotEntity.Tests.SqlGeneratorTests
{
    ...
    public class SqliteQueryGenerationTests : DotEntityTest
    {
        ...
        {
            var sql = _generator.GenerateSelect(out IList<QueryInfo> queryInfos, new List<Expression<Func<Product, bool>>>
            {
        ...
        {
            var sql = _generator.GenerateSelect(out IList<QueryInfo> queryParameters, new List<Expression<Func<Product, bool>>>
            {
                product => product.ProductName == "Ice Candy"
            });
        ...
        {
            var sql = _generator.GenerateSelectWithTotalMatchingCount(out IList<QueryInfo> queryParameters, new List<Expression<Func<Product, bool>>>
            {
                product => product.ProductName == "Ice Candy"
            });
        ...
        {
            var str = "Ice Candy";
            var sql = _generator.GenerateSelect<Product>(out IList<QueryInfo> queryParameters, new List<Expression<Func<Product, bool>>>
            {
        ...
        {
            var lst = new List<int> { 1, 2, 3, 4 };
            var sql = _generator.GenerateCount(new List<Expression<Func<Product, bool>>>
            {
                product => product.ProductName == GetName(),
                product => !lst.Contains(product.Id)
        ...
        {
            var sql = _generator.GenerateJoin<Product>(out IList<QueryInfo> queryParameters, new List<IJoinMeta>()
            {
