...
{
    [TestFixture]
    public class PostgreSqlTableGeneratorTests : DotEntityTest
    {
        private IDatabaseTableGenerator generator;
        [OneTimeSetUp]
        public void Init()
        {
            DotEntityDb.Initialize(PostgreSqlConnectionString, new PostgreSqlDatabaseProvider("testdb"));
        ...
        public void DeleteForeignKeyConstraint_Succeeds()
        {
            ...
            var expected = "ALTER TABLE \"ProductCategory\"" + Environment.NewLine + "DROP CONSTRAINT \"cFK_Product_Id_ProductCategory_ProductId\";";
            Assert.AreEqual(expected, sql);
        }
        ...
        public void DropIndex_Succeeds()
        {
            ...
            var expected = $"DROP INDEX Idx_DateCreated;";
            Assert.AreEqual(expected, sql);
